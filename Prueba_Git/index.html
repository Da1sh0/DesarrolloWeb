...
<head>
	...
	<link rel="icon" href="https://freesvg.org/img/1534129544.png">
	...
	<header>
		<nav>
			<ul class="nav-right-section">
				...
				<li class="menu">
					<a href=""> <img src="https://cdn-icons-png.flaticon.com/512/17/17704.png" alt="menu"></a>
				</li>
				<li class="photo">
					<a href=""><img src="https://lh3.googleusercontent.com/ogw/ADea4I46u6rhaBUL__R9_jxZY5wIcbcIQZXGDSy-rln-qgI=s32-c-mo" alt="Foto de perfil"></a>
				</li>
			</ul>
		</nav>
	</header>
	<main>
		<section class="main-google">
